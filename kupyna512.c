...
{
    y[0]  = (T0[(uint8_t)x[0]]  ^ T1[(uint8_t)(x[15] >> 8)] ^ T2[(uint8_t)(x[14] >> 16)] ^ T3[(uint8_t)(x[13] >> 24)] ^ T4[(uint8_t)(x[12] >> 32)] ^ T5[(uint8_t)(x[11] >> 40)] ^ T6[(uint8_t)(x[10] >> 48)] ^ T7[(uint8_t)(x[5] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 0)  * 0x10) ^ round) << 56));
    y[1]  = (T0[(uint8_t)x[1]]  ^ T1[(uint8_t)(x[0] >> 8)]  ^ T2[(uint8_t)(x[15] >> 16)] ^ T3[(uint8_t)(x[14] >> 24)] ^ T4[(uint8_t)(x[13] >> 32)] ^ T5[(uint8_t)(x[12] >> 40)] ^ T6[(uint8_t)(x[11] >> 48)] ^ T7[(uint8_t)(x[6] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 1)  * 0x10) ^ round) << 56));
    y[2]  = (T0[(uint8_t)x[2]]  ^ T1[(uint8_t)(x[1] >> 8)]  ^ T2[(uint8_t)(x[0] >> 16)]  ^ T3[(uint8_t)(x[15] >> 24)] ^ T4[(uint8_t)(x[14] >> 32)] ^ T5[(uint8_t)(x[13] >> 40)] ^ T6[(uint8_t)(x[12] >> 48)] ^ T7[(uint8_t)(x[7] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 2)  * 0x10) ^ round) << 56));
    y[3]  = (T0[(uint8_t)x[3]]  ^ T1[(uint8_t)(x[2] >> 8)]  ^ T2[(uint8_t)(x[1] >> 16)]  ^ T3[(uint8_t)(x[0] >> 24)]  ^ T4[(uint8_t)(x[15] >> 32)] ^ T5[(uint8_t)(x[14] >> 40)] ^ T6[(uint8_t)(x[13] >> 48)] ^ T7[(uint8_t)(x[8] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 3)  * 0x10) ^ round) << 56));
    y[4]  = (T0[(uint8_t)x[4]]  ^ T1[(uint8_t)(x[3] >> 8)]  ^ T2[(uint8_t)(x[2] >> 16)]  ^ T3[(uint8_t)(x[1] >> 24)]  ^ T4[(uint8_t)(x[0] >> 32)]  ^ T5[(uint8_t)(x[15] >> 40)] ^ T6[(uint8_t)(x[14] >> 48)] ^ T7[(uint8_t)(x[9] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 4)  * 0x10) ^ round) << 56));
    y[5]  = (T0[(uint8_t)x[5]]  ^ T1[(uint8_t)(x[4] >> 8)]  ^ T2[(uint8_t)(x[3] >> 16)]  ^ T3[(uint8_t)(x[2] >> 24)]  ^ T4[(uint8_t)(x[1] >> 32)]  ^ T5[(uint8_t)(x[0] >> 40)]  ^ T6[(uint8_t)(x[15] >> 48)] ^ T7[(uint8_t)(x[10] >> 56)]) + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 5)  * 0x10) ^ round) << 56));
    y[6]  = (T0[(uint8_t)x[6]]  ^ T1[(uint8_t)(x[5] >> 8)]  ^ T2[(uint8_t)(x[4] >> 16)]  ^ T3[(uint8_t)(x[3] >> 24)]  ^ T4[(uint8_t)(x[2] >> 32)]  ^ T5[(uint8_t)(x[1] >> 40)]  ^ T6[(uint8_t)(x[0] >> 48)]  ^ T7[(uint8_t)(x[11] >> 56)]) + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 6)  * 0x10) ^ round) << 56));
    y[7]  = (T0[(uint8_t)x[7]]  ^ T1[(uint8_t)(x[6] >> 8)]  ^ T2[(uint8_t)(x[5] >> 16)]  ^ T3[(uint8_t)(x[4] >> 24)]  ^ T4[(uint8_t)(x[3] >> 32)]  ^ T5[(uint8_t)(x[2] >> 40)]  ^ T6[(uint8_t)(x[1] >> 48)]  ^ T7[(uint8_t)(x[12] >> 56)]) + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 7)  * 0x10) ^ round) << 56));
    y[8]  = (T0[(uint8_t)x[8]]  ^ T1[(uint8_t)(x[7] >> 8)]  ^ T2[(uint8_t)(x[6] >> 16)]  ^ T3[(uint8_t)(x[5] >> 24)]  ^ T4[(uint8_t)(x[4] >> 32)]  ^ T5[(uint8_t)(x[3] >> 40)]  ^ T6[(uint8_t)(x[2] >> 48)]  ^ T7[(uint8_t)(x[13] >> 56)]) + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 8)  * 0x10) ^ round) << 56));
    y[9]  = (T0[(uint8_t)x[9]]  ^ T1[(uint8_t)(x[8] >> 8)]  ^ T2[(uint8_t)(x[7] >> 16)]  ^ T3[(uint8_t)(x[6] >> 24)]  ^ T4[(uint8_t)(x[5] >> 32)]  ^ T5[(uint8_t)(x[4] >> 40)]  ^ T6[(uint8_t)(x[3] >> 48)]  ^ T7[(uint8_t)(x[14] >> 56)]) + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 9)  * 0x10) ^ round) << 56));
    y[10] = (T0[(uint8_t)x[10]] ^ T1[(uint8_t)(x[9] >> 8)]  ^ T2[(uint8_t)(x[8] >> 16)]  ^ T3[(uint8_t)(x[7] >> 24)]  ^ T4[(uint8_t)(x[6] >> 32)]  ^ T5[(uint8_t)(x[5] >> 40)]  ^ T6[(uint8_t)(x[4] >> 48)]  ^ T7[(uint8_t)(x[15] >> 56)]) + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 10) * 0x10) ^ round) << 56));
    y[11] = (T0[(uint8_t)x[11]] ^ T1[(uint8_t)(x[10] >> 8)] ^ T2[(uint8_t)(x[9] >> 16)]  ^ T3[(uint8_t)(x[8] >> 24)]  ^ T4[(uint8_t)(x[7] >> 32)]  ^ T5[(uint8_t)(x[6] >> 40)]  ^ T6[(uint8_t)(x[5] >> 48)]  ^ T7[(uint8_t)(x[0] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 11) * 0x10) ^ round) << 56));
    y[12] = (T0[(uint8_t)x[12]] ^ T1[(uint8_t)(x[11] >> 8)] ^ T2[(uint8_t)(x[10] >> 16)] ^ T3[(uint8_t)(x[9] >> 24)]  ^ T4[(uint8_t)(x[8] >> 32)]  ^ T5[(uint8_t)(x[7] >> 40)]  ^ T6[(uint8_t)(x[6] >> 48)]  ^ T7[(uint8_t)(x[1] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 12) * 0x10) ^ round) << 56));
    y[13] = (T0[(uint8_t)x[13]] ^ T1[(uint8_t)(x[12] >> 8)] ^ T2[(uint8_t)(x[11] >> 16)] ^ T3[(uint8_t)(x[10] >> 24)] ^ T4[(uint8_t)(x[9] >> 32)]  ^ T5[(uint8_t)(x[8] >> 40)]  ^ T6[(uint8_t)(x[7] >> 48)]  ^ T7[(uint8_t)(x[2] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 13) * 0x10) ^ round) << 56));
    y[14] = (T0[(uint8_t)x[14]] ^ T1[(uint8_t)(x[13] >> 8)] ^ T2[(uint8_t)(x[12] >> 16)] ^ T3[(uint8_t)(x[11] >> 24)] ^ T4[(uint8_t)(x[10] >> 32)] ^ T5[(uint8_t)(x[9] >> 40)]  ^ T6[(uint8_t)(x[8] >> 48)]  ^ T7[(uint8_t)(x[3] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 14) * 0x10) ^ round) << 56));
    y[15] = (T0[(uint8_t)x[15]] ^ T1[(uint8_t)(x[14] >> 8)] ^ T2[(uint8_t)(x[13] >> 16)] ^ T3[(uint8_t)(x[12] >> 24)] ^ T4[(uint8_t)(x[11] >> 32)] ^ T5[(uint8_t)(x[10] >> 40)] ^ T6[(uint8_t)(x[9] >> 48)]  ^ T7[(uint8_t)(x[4] >> 56)])  + (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - 15) * 0x10) ^ round) << 56));
}
...
static inline void Q(uint64_t* x, uint64_t* y, uint64_t round)
{
    for (uint_fast32_t j = 0; j < 16; ++j) {
        x[j] += (0x00F0F0F0F0F0F0F3ULL ^ ((((15 - j) * 0x10) ^ round) << 56));
    }
...
static void outputTransform(struct kupyna512_ctx_t* ctx)
{
    ...
    for (uint_fast32_t column=0; column<16; column+=2) {
...
#if defined(__SSE2__)
    for (uint8_t column=0; column<8; column+=4) {
...
#elif defined(__MMX__)
    for (uint8_t column=0; column<16; column+=2) {
...
#elif defined(__MMX__)
    for (uint8_t column=0; column<16; column += 4) {
